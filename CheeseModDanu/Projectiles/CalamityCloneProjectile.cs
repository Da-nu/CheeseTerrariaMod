...
{
	public class CalamityCloneProjectile : ModProjectile
	{
		...
		public override void OnSpawn(IEntitySource source)
        {
			...
			//if (cloneCodeUsed == false)
			//{
			//cloneCodeUsed = true;
			//for (int i = 0; i < 1; i++)
			//{
			//Projectile.NewProjectile(source, Projectile.position - (new Vector2(86, 25) * (i + 1)), Projectile.velocity, Projectile.type, Projectile.damage, Projectile.knockBack, Projectile.owner, Projectile.ai[0], Projectile.ai[1]);
			//}
			//}
		}
