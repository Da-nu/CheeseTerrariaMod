...
{
	public class CalamityProjectile : ModProjectile
	{
		...
		{
			DisplayName.SetDefault("Calamity Sword Projectile"); // Name of the projectile. It can be appear in chat
		...
		{
			Projectile.width = 86; // The width of projectile hitbox
		...
		int cloneType = ModContent.ProjectileType<CalamityCloneProjectile>();
		...
		public override void OnSpawn(IEntitySource source)
        {
			...
			Projectile.NewProjectile(source, Projectile.position - (new Vector2(-50, 5)), Projectile.velocity, cloneType, Projectile.damage, Projectile.knockBack, Projectile.owner, Projectile.ai[0], Projectile.ai[1]);
			Projectile.position += new Vector2(0, 5);
		}
		...
		public override void AI()
		{
			...
			Lighting.AddLight(Projectile.position, 192 / dividedBy, 81 / dividedBy, 255 / dividedBy);
