...
{
	public class SupremeProjectile : ModProjectile
	{
		...
		{
			DisplayName.SetDefault("Supreme Sword Projectile"); // Name of the projectile. It can be appear in chat
		...
		int cloneType = ModContent.ProjectileType<CloneProjectile>();
		...
		public override void OnSpawn(IEntitySource source)
        {
			...
			Projectile.NewProjectile(source, Projectile.position - (new Vector2(-50, 35)), Projectile.velocity, cloneType, Projectile.damage, Projectile.knockBack, Projectile.owner, Projectile.ai[0], Projectile.ai[1]);
			Projectile.NewProjectile(source, Projectile.position - (new Vector2(-50, -25)), Projectile.velocity, cloneType, Projectile.damage, Projectile.knockBack, Projectile.owner, Projectile.ai[0], Projectile.ai[1]);
			Projectile.position += new Vector2(0, -30);
		}
