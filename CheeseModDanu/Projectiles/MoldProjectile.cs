...
{
	public class MoldProjectile : ModProjectile
	{
		...
		{
			DisplayName.SetDefault("Old Cheese Sword Projectile"); // Name of the projectile. It can be appear in chat
		...
		{
			Projectile.width = 71; // The width of projectile hitbox
			Projectile.height = 21; // The height of projectile hitbox
